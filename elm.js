...
var $author$project$Main$message = _Platform_incomingPort('message', $elm$json$Json$Decode$string);
var $elm$json$Json$Decode$null = _Json_decodeNull;
var $author$project$Main$ready = _Platform_incomingPort(
	'ready',
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$ready($author$project$Main$Ready),
				$author$project$Main$message($author$project$Main$Message)
			]));
};
	...
	function (msg, model) {
		if (msg.$ === 'Ready') {
			return _Utils_Tuple2(
				_Utils_Tuple0,
				$author$project$Main$print('Logged in'));
		} else {
			var str = msg.a;
			if (A2($elm$core$String$startsWith, '!', str)) {
				var _v1 = A2($elm$core$String$dropLeft, 1, str);
				if (_v1 === 'neko') {
					return _Utils_Tuple2(
						_Utils_Tuple0,
						$author$project$Main$send('にゃーん'));
				} else {
					return _Utils_Tuple2(
						_Utils_Tuple0,
						$author$project$Main$send('ねこじゃないなにか'));
				}
			} else {
				return _Utils_Tuple2(_Utils_Tuple0, $elm$core$Platform$Cmd$none);
			}
